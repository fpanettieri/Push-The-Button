package com.gamingfondue.ptb.worlds.splash
{
	...
	public class FlashPunk extends Entity
	{
		...
		public var cog:Image = new Image(Assets.SPLASH_COG);
		public var leftText:Image = new Image(Assets.SPLASH_LEFT);
		public var rightText:Image = new Image(Assets.SPLASH_RIGHT);
		 ...
		 */
		public function FlashPunk(color:uint = 0xFF3366, bgColor:uint = 0x202020, fadeTime:Number = .5, spinTime:Number = 2, spinPause:Number = .5, spins:Number = 720) 
		{
