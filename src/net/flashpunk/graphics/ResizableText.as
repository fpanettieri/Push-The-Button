package net.flashpunk.graphics
{
	 ...
	 */
	public class ResizableText extends Image
	{
		/**
		 ...
		 */
		public function ResizableText(text:String, x:Number = 0, y:Number = 0, options:Object = null, h:Number = 0)
		{
			_font = ResizableText.font;
			_size = ResizableText.size;
			_align = ResizableText.align;
			_leading = ResizableText.defaultLeading;
			_wordWrap = ResizableText.wordWrap;
			resizable = ResizableText.resizable;
			var width:uint = 0;
			var height:uint = h;
